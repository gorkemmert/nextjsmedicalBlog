const FancyBlock = () => {
  ...
  const data = {
    title: (
      <>
        <span>Bilgi &amp; Deneyim</span>
        <br />  ile Güvenilir Çözümler
      </>
    ),
    subtitle:
      "Beşeri tıbbi ürünlerin ruhsatlandırılması, tıbbi cihaz kayıtları ve medikal çeviri alanlarında uzman kadromuzla hizmet sunuyoruz. Mevzuata tam uyumlu süreçlerimiz sayesinde, müşterilerimizin işlerini hızlandırarak güvenilir ve etkili çözümler üretiyoruz.",
    author: "Pharmalect Ekibi",
    authorTitle: "",
  };
      ...
      >
        <div className="img-meta-two d-inline-block position-relative pb-50">
          ...
          <div className="card-one" data-aos="fade-up" data-aos-delay="250">
            ...
            <h5 className="fw-500 m0">Sağlık sektöründe doğru adımlar atmanız için yanınızdayız.</h5>
          </div>
          {/* /.card-one */}
        </div>
        {/* /.img-meta-two */}
